# -*- coding: utf-8 -*-
"""
Created on Sat Oct 20 09:53:11 2018

@author: huan
"""
import tensorflow as tf
from utils import batch_normalization
from utils import dice_coe
...
class U_net():
    ...
    def u_net_model(self,image,w_inputs,h_inputs,batch_size,input_channels=3,n_classs=1,keep_prob=0.5,base_channel=64):
...
#        return conv9_3_sigmoid    
    ...
    def loss(self,y):
        self.cost=dice_coe(self.y_pred,y)
